...
Synaptic Parameters for thalamic inputs according to Smeal
*****************************************************************************/
	...
	float EkAMPA = 0.0
        ...
        float AMPAgmax = 0.361e-9  //AMPA is 0.361 for Smeal et al., 2008 data showing thalamostriatal synapses have 2.6/1 NMDA/AMPA ratio
...
// cortex
str	    subunit = "ThalSmeal"
float   EkNMDA   = 0
float	Kmg       = 3.57
float	NMDAtau2      = (193e-3)/2 	//193 is recorded tau decay for th-st syanpses in smeal et al 2008
